...
using Clauses.Services.Rules.Task;
...
using Contract.Services.Rules.Task;
using Ninject;
...
using Types.Services.Rules.Task;
...
namespace EYZ.Infrastructure
{
    public static class NinjectBindingsConfigurator
    {
        ...
        public static void Start()
        {
            ...
            _kernel.Bind<ITypeTask>().To<TypeServices>().WithConstructorArgument("connectionString", ConfigurationManager.ConnectionStrings["ConnectionString.Business.Web"].ConnectionString);
            _kernel.Bind<IClausesTask>().To<ClausesServices>().WithConstructorArgument("connectionString", ConfigurationManager.ConnectionStrings["ConnectionString.Business.Web"].ConnectionString);
            _kernel.Bind<IContractTask>().To<ContractServices>().WithConstructorArgument("connectionString", ConfigurationManager.ConnectionStrings["ConnectionString.Business.Web"].ConnectionString);
            _kernel.Bind<INegotiationTask>().To<NegotiationServices>().WithConstructorArgument("connectionString", ConfigurationManager.ConnectionStrings["ConnectionString.Business.Web"].ConnectionString);
