...
(/** @lends <global> */function( $ ) {
	 ...
	 * fire off triggers in time sensitive applications (for example cell Description)
	 * as its slow.
	 *  @param {object} settings dataTables settings object
	 ...
	 *
	 * The structure is built in order to speed Description and extension of the Api
	...
	DataTable.defaults = {
		 ...
		 * true, will cause DataTables to defer the Description of the table elements for
	...
	DataTable.models.oSettings = {
		...
		"oFeatures": {
			...
			/**
			 * Delay the Description of TR and TD elements until they are actually
